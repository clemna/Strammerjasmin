...
{
	public CharacterControllerMap Character;
	public Pin StartPin;
	...
	private void CheckForInput()
	{
        ...
        {
			LevelLoader.LoadLevel(Character.CurrentPin.SceneToLoad);
        }
	}
	...
	{
		SelectedLevelText.text = string.Format("Current Level: {0} \nCollected Souls: 0/0", Character.CurrentPin.SceneToLoad);
	}
}
